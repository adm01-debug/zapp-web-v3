    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="overview" className="space-y-4">
                    ...
                    <AreaChart data={timelineData}>
                      ...
                      {functionNames.map((fn) => (
                        <Area
                          ...
                          dataKey={fn}
                          stackId="1"
                          fill={FUNCTION_COLORS[fn]}
                          stroke={FUNCTION_COLORS[fn]}
                          fillOpacity={0.6}
                  ...
                  <>
                    <ResponsiveContainer width="100%" height={180}>
                      <PieChart>
                        ...
                        <Tooltip formatter={(v: any) => String(v.toLocaleString()) + ' tokens'} />
                      </PieChart>
                    </ResponsiveContainer>
        ...
        <TabsContent value="users" className="space-y-4">
          <AIUsageUsersTab userUsage={userUsage} profileMap={profileMap} />
        </TabsContent>
