...
export function ConversationContextMenu({
  ...
  return (
    <ContextMenu>
      ...
      <ContextMenuContent className="w-56 bg-foreground border-border shadow-none">
        {/* Header */}
        ...
        <ContextMenuSub>
          ...
          <ContextMenuSubContent className="w-40 bg-foreground border-border shadow-none">
            <ContextMenuItem
        ...
        <ContextMenuSub>
          ...
          <ContextMenuSubContent className="w-48 bg-foreground border-border shadow-none">
            <ContextMenuItem
