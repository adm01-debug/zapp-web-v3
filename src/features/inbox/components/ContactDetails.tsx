...
export function ContactDetails({ conversation, onClose }: ContactDetailsProps) {
  ...
  return (
    <motion.div
      ...
      tabIndex={-1}
      className="w-80 h-full min-h-0 shrink-0 bg-[#0b141a] dark:bg-[#0b141a] border-l border-border flex flex-col overflow-hidden focus:outline-none focus:ring-2 focus:ring-primary/40"
    >
      <div className="flex items-center justify-between px-4 py-3 border-b border-border/50 bg-[#0b141a] dark:bg-[#0b141a] shrink-0">
