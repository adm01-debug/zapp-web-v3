...
export function ContactDetails({ conversation, onClose }: ContactDetailsProps) {
  ...
  return (
    <motion.div
      ...
      tabIndex={-1}
      className="w-80 h-full min-h-0 shrink-0 bg-background border-l border-border flex flex-col overflow-hidden focus:outline-none focus:ring-2 focus:ring-primary/40"
    >
