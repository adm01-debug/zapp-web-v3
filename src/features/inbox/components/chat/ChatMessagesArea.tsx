...
export const ChatMessagesArea = memo(forwardRef<ChatMessagesAreaRef, ChatMessagesAreaProps>(({
  ...
  return (
    <div ref={scrollContainerRef} role="log" aria-label="Mensagens da conversa" aria-live="polite" aria-relevant="additions" className="flex-1 min-h-0 min-w-0 overflow-y-auto px-4 py-4 md:px-24 space-y-1.5 scrollbar-none bg-background relative transition-colors duration-500 font-sans text-[15px] font-semibold tracking-normal focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary/20" style={{ fontFamily: 'Outfit, sans-serif' }} tabIndex={0}>
      <ChatWatermark />
