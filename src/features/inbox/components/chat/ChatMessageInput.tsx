        ...
        <div className="flex items-end gap-1">
          ...
          <div className="flex-1 relative group min-w-0">
            ...
            <Textarea ref={textareaRef} value={inputValue} onChange={handleInputChange} onKeyDown={handleKeyDown} onBlur={onTypingStop}
              ...
              className={cn("min-h-[40px] max-h-[120px] resize-none pr-10 glass border-border/50 focus:border-primary/50 focus:ring-primary/20 transition-all font-sans text-[15px] font-semibold tracking-normal", isMobile ? "py-2.5 text-[16px] rounded-2xl leading-snug" : "py-2.5", isSending && "opacity-50 pointer-events-none")}
              rows={1}
              disabled={isSending}
            />
