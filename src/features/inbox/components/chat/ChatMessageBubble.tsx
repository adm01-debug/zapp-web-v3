        ...
        <motion.div
          ...
          className={cn(
            ...
            message.isWhisper
              ...
              : isSent 
                ? 'rounded-lg rounded-tr-none bg-[#1e3a5f] text-[hsl(var(--foreground))]' 
                : 'rounded-lg rounded-tl-none bg-card text-[hsl(var(--foreground))]'
          )}
        >
          {!message.isWhisper && (
            <div className={cn(
          ...
          {message.content && message.type !== 'audio' && message.type !== 'location' && message.type !== 'video' && message.type !== 'document' && message.type !== 'sticker' && (
            <div className="flex flex-col gap-1">
              ...
              <TextWithLinks text={message.content} className={cn("text-[14.2px] font-normal tracking-normal whitespace-pre-wrap leading-[1.35]", message.isWhisper && "italic")} maxPreviews={2} />
            </div>
          )}
