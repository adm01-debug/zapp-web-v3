        ...
        >
           ...
           {message.type === 'video' && (
             <div className="mb-2">
               <VideoPreview
                 ...
                 isPtv={message.message_type === 'ptvMessage' || (message.media_meta as any)?.ptt === true || (message.media_meta as any)?.isPtv === true}
               />
             </div>
           )}
          ...
          {message.content && message.type !== 'audio' && message.type !== 'location' && message.type !== 'video' && message.type !== 'document' && message.type !== 'sticker' && (
            <div className="flex flex-col gap-1">
              ...
              <TextWithLinks text={message.content} className={cn("font-sans text-[13.5px] font-normal tracking-normal whitespace-pre-wrap leading-[1.35]", message.isWhisper && "italic")} maxPreviews={2} />
            </div>
          )}
