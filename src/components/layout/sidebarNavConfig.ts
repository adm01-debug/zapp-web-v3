...
export const systemNav: readonly NavItemConfig[] = [
  ...
  { id: 'agents-ops', icon: UsersRound, label: 'Atendentes Online', requiredRoles: ['admin', 'supervisor'] },
...
export const advancedNav: readonly NavItemConfig[] = [
  ...
  { id: 'alert-history', icon: Bell, label: 'Histórico de Alertas', requiredRoles: ['admin', 'supervisor'] },
