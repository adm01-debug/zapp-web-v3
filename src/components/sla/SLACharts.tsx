          ...
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={dailyData}>
              ...
              <Tooltip
                ...
                formatter={((value: number) => [`${value.toFixed(1)}%`, 'Taxa SLA']) as any}
              />
              <Area
                type="monotone"
                dataKey="slaRate"
  ...
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
      <Card>
        ...
        <CardContent>
          {worstDays.length === 0 ? (
            <p className="py-4 text-center text-muted-foreground">Nenhuma violação registrada</p>
          ) : (
      ...
      <Card>
        ...
        <CardContent>
          {bestDays.length === 0 ? (
            <p className="py-4 text-center text-muted-foreground">Nenhum dado disponível</p>
          ) : (
            <div className="space-y-3">
              {bestDays.map((day, i) => (
                <motion.div
