...
const SLA_CONFIG: Record<SLAStatus, { label: string; icon: React.ReactNode; colorClass: string }> = {
  within:   { label: 'Dentro do SLA', icon: <CheckCircle2 className="h-3 w-3" />, colorClass: 'text-green-700 border-green-300 bg-primary/10 dark:bg-green-950/30 dark:text-green-400' },
