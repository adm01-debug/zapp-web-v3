      ...
      <div className="max-w-[70%] space-y-1 relative">
        ...
        {message.is_deleted ? (
          ...
          <div className={cn(
            ...
            {message.type === 'audio' && message.mediaUrl && <div className="mb-2"><AudioMessagePlayer audioUrl={message.mediaUrl} messageId={message.id} isSent={isSent} existingTranscription={message.transcription} transcriptionStatus={message.transcriptionStatus} refreshKey={mediaRefreshKey} conversationId={contactJid ?? null} /></div>}
