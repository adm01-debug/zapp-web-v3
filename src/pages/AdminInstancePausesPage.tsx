...
import { AuthEventTrendChart } from '@/features/admin/instance-pauses/AuthEventTrendChart';
import { IncidentDetailDialog, type IncidentPause } from '@/features/admin/instance-pauses/IncidentDetailDialog';
