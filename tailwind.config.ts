  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "2xs": ["0.5625rem", { lineHeight: "0.75rem", letterSpacing: "0.02em" }],
        xs: ["0.6875rem", { lineHeight: "0.875rem", letterSpacing: "0.015em" }],
        ...
        "5xl": ["2.5rem", { lineHeight: "2.75rem", letterSpacing: "-0.035em" }],
        "6xl": ["3rem", { lineHeight: "3.25rem", letterSpacing: "-0.04em" }],
        "7xl": ["3.75rem", { lineHeight: "4rem", letterSpacing: "-0.04em" }],
        "8xl": ["5rem", { lineHeight: "5.25rem", letterSpacing: "-0.05em" }],
        "9xl": ["7rem", { lineHeight: "7.25rem", letterSpacing: "-0.05em" }],
      },
      colors: {
