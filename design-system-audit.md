...
|---|---|---|---|---|---|
| Low | 41 | `#888` | `#888` | Check design system tokens | - |
...
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| Low | 68 | `#f0fdf4` | `#f0fdf4` | Check design system tokens | - |
| Low | 68 | `#86efac` | `#86efac` | Check design system tokens | - |
| Low | 68 | `#22c55e` | `#22c55e` | Check design system tokens | - |
| Low | 68 | `#15803d` | `#15803d` | Check design system tokens | - |
| Low | 68 | `#14532d` | `#14532d` | Check design system tokens | - |
| Low | 74 | `#fef9c3` | `#fef9c3` | Check design system tokens | - |
| Low | 74 | `#fde047` | `#fde047` | Check design system tokens | - |
| Low | 74 | `#facc15` | `#facc15` | Check design system tokens | - |
| Low | 74 | `#eab308` | `#eab308` | Check design system tokens | - |
| Low | 74 | `#ca8a04` | `#ca8a04` | Check design system tokens | - |
| Low | 80 | `#fef2f2` | `#fef2f2` | Check design system tokens | - |
| Low | 80 | `#fecaca` | `#fecaca` | Check design system tokens | - |
...
| Low | 22 | `#10B981` | `#10B981` | Check design system tokens | - |
| Low | 23 | `#F59E0B` | `#F59E0B` | Check design system tokens | - |
| Low | 24 | `#EF4444` | `#EF4444` | Check design system tokens | - |
| Low | 25 | `#8B5CF6` | `#8B5CF6` | Check design system tokens | - |
...
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| Low | 295 | `#251F33` | `#251F33` | Check design system tokens | - |
## src/components/tags/TagsView.tsx
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| Low | 40 | `#ef4444` | `#ef4444` | Check design system tokens | - |
| Low | 41 | `#f97316` | `#f97316` | Check design system tokens | - |
| Low | 42 | `#eab308` | `#eab308` | Check design system tokens | - |
| Low | 43 | `#22c55e` | `#22c55e` | Check design system tokens | - |
| Low | 44 | `#06b6d4` | `#06b6d4` | Check design system tokens | - |
| Low | 45 | `#3b82f6` | `#3b82f6` | Check design system tokens | - |
| Low | 46 | `#8b5cf6` | `#8b5cf6` | Check design system tokens | - |
| Low | 47 | `#ec4899` | `#ec4899` | Check design system tokens | - |
| Low | 48 | `#6b7280` | `#6b7280` | Check design system tokens | - |
...
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| High | 255 | `#fff` | `#fff` | bg-background | - |
| High | 255 | `#fff` | `#fff` | bg-background | - |
...
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| Low | 86 | `#666` | `#666` | Check design system tokens | - |
| Low | 91 | `#666` | `#666` | Check design system tokens | - |
...
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| Low | 33 | `#3b82f6` | `#3b82f6` | Check design system tokens | - |
| Low | 34 | `#8b5cf6` | `#8b5cf6` | Check design system tokens | - |
| Low | 35 | `#f59e0b` | `#f59e0b` | Check design system tokens | - |
| Low | 36 | `#10b981` | `#10b981` | Check design system tokens | - |
| Low | 37 | `#ef4444` | `#ef4444` | Check design system tokens | - |
...
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| Low | 19 | `font-inter` | `font-inter` | Remove literal font; use global typography | - |
| Low | 36 | `font-inter` | `font-inter` | Remove literal font; use global typography | - |
...
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| Low | 84 | `#310` | `#310` | Check design system tokens | - |
## src/features/inbox/components/linkPreviewUtils.ts
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| Low | 50 | `#039` | `#039` | Check design system tokens | - |
## src/features/inbox/components/monitoring/QueueMetricsDashboard.tsx
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| Low | 16 | `#0088FE` | `#0088FE` | Check design system tokens | - |
...
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| Low | 106 | `#3B82F6` | `#3B82F6` | Check design system tokens | - |
...
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| Low | 90 | `#888` | `#888` | Check design system tokens | - |
| Low | 91 | `#3b82f6` | `#3b82f6` | Check design system tokens | - |
| Low | 92 | `#16a34a` | `#16a34a` | Check design system tokens | - |
| Low | 93 | `#d97706` | `#d97706` | Check design system tokens | - |
| Low | 94 | `#dc2626` | `#dc2626` | Check design system tokens | - |
| Low | 95 | `#888` | `#888` | Check design system tokens | - |
## src/main.tsx
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
...
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| Low | 83 | `#3B82F6` | `#3B82F6` | Check design system tokens | - |
| Low | 160 | `#3B82F6` | `#3B82F6` | Check design system tokens | - |
| Low | 480 | `#3B82F6` | `#3B82F6` | Check design system tokens | - |
...
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| Low | 100 | `#3B82F6` | `#3B82F6` | Check design system tokens | - |
| Low | 220 | `#3B82F6` | `#3B82F6` | Check design system tokens | - |
| Low | 242 | `#3B82F6` | `#3B82F6` | Check design system tokens | - |
...
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| High | 171 | `#000000` | `#000000` | bg-foreground | - |
| High | 177 | `#000000` | `#000000` | bg-foreground | - |
## src/utils/emailMappers.test.ts
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| Low | 122 | `#ff0000` | `#ff0000` | Check design system tokens | - |
## src/DS_TEST_FILE.tsx
| Priority | Line | Raw Match | Clean | Suggestion | Patch |
|---|---|---|---|---|---|
| Low | 11 | `font-inter` | `font-inter` | Remove literal font; use global typography | - |
| Low | 17 | `text-[#ff0000]` | `text-[#ff0000]` | Check design system tokens | - |
