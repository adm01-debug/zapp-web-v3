...
|----------|------|------|-------|------------|
| Low | 94 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 198 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/calls/DialPad.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 154 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/campaigns/CampaignsView.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 158 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 77 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 212 | Literal Color | `text-red-400` | Use semantic tokens (destructive, muted, popover, etc.) |

## src/components/connections/IdempotencyMissBanner.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 81 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 109 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 133 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/connections/OfficialApiConfigDialog.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 127 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 22 | Literal Color | `bg-pink-100` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 177 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Medium | 29 | Literal Color | `text-red-600` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 30 | Literal Color | `bg-amber-100` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 30 | Literal Color | `text-amber-600` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 30 | Literal Color | `bg-yellow-100` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 30 | Literal Color | `text-yellow-600` | Use semantic tokens (destructive, muted, popover, etc.) |

## src/components/contacts/ContactAnalyticsDashboard.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 97 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 98 | Literal Color | `bg-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 108 | Literal Color | `text-orange-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 109 | Literal Color | `bg-orange-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 247 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Low | 183 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 120 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Medium | 31 | Literal Color | `text-purple-700` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 33 | Literal Color | `bg-amber-100` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 33 | Literal Color | `text-amber-700` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 145 | Literal Color | `text-amber-400` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 88 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 46 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 47 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Medium | 24 | Literal Color | `text-purple-700` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 25 | Literal Color | `bg-amber-100` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 25 | Literal Color | `text-amber-700` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 27 | Literal Color | `bg-red-100` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 27 | Literal Color | `text-red-700` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Medium | 27 | Literal Color | `text-purple-700` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 28 | Literal Color | `bg-amber-100` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 42 | Literal Color | `bg-blue-100` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 42 | Literal Color | `text-blue-700` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 42 | Literal Color | `bg-cyan-100` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 42 | Literal Color | `text-cyan-700` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 43 | Literal Color | `bg-purple-100` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 43 | Literal Color | `text-purple-700` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 44 | Literal Color | `bg-amber-100` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 44 | Literal Color | `text-amber-700` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Low | 554 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 558 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 562 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 566 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 570 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 576 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 189 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 89 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 112 | Literal Color | `text-red-500` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 38 | Literal Color | `bg-red-100` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 38 | Literal Color | `text-red-700` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 39 | Literal Color | `bg-orange-100` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 103 | Literal Color | `bg-blue-100` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 103 | Literal Color | `text-blue-700` | Use semantic tokens (destructive, muted, popover, etc.) |

## src/components/csat/CSATWidget.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 27 | Literal Color | `text-amber-600` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 28 | Literal Color | `text-red-600` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 37 | Literal Color | `text-amber-400` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 105 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 129 | Literal Color | `text-red-600` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 130 | Literal Color | `text-amber-600` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 140 | Literal Color | `text-red-600` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 147 | Literal Color | `bg-amber-400` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 150 | Literal Color | `bg-red-500` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 240 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 66 | Literal Color | `text-amber-400` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 160 | Literal Color | `text-amber-400` | Use semantic tokens (destructive, muted, popover, etc.) |
| Low | 156 | Literal Font | `font-sans` | Remove literal font class; use global typography |
| Low | 167 | Literal Font | `font-sans` | Remove literal font class; use global typography |
| Low | 181 | Literal Font | `font-sans` | Remove literal font class; use global typography |
| Low | 185 | Literal Font | `font-sans` | Remove literal font class; use global typography |
| Low | 247 | Literal Font | `font-sans` | Remove literal font class; use global typography |
| Low | 252 | Literal Font | `font-sans` | Remove literal font class; use global typography |

## src/components/email/EmailChatReplyBar.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 153 | Literal Font | `font-sans` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 166 | Literal Color | `text-amber-700` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 166 | Literal Color | `bg-amber-100` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 186 | Literal Color | `text-yellow-500` | Use semantic tokens (destructive, muted, popover, etc.) |
...
|----------|------|------|-------|------------|
| Medium | 98 | Literal Color | `text-red-600` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 100 | Literal Color | `text-amber-600` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 111 | Literal Color | `text-amber-600` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 129 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/layout/Sidebar.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 68 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 78 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 101 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 103 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/layout/SidebarNavItem.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 128 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Low | 60 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 69 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 74 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 160 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 169 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/monitoring/DLQPanel.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 151 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 214 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 215 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 223 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 259 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 265 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 269 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/monitoring/EvolutionMonitoringDashboard.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 32 | Literal Color | `bg-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 25 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 123 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 141 | Literal Color | `text-amber-600` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Medium | 142 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |

## src/components/monitoring/MonitoringSLAPanel.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 72 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 125 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |

## src/components/monitoring/MonitoringStatsCards.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 85 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 86 | Literal Color | `bg-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 107 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 108 | Literal Color | `bg-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 114 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |

## src/components/monitoring/MonitoringWebhookPanel.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 229 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Low | 105 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 108 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 215 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/monitoring/RetryAlertsBanner.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 27 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 44 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/monitoring/RetryMetricsPanel.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 393 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 530 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Low | 305 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 316 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 320 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 344 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 353 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 536 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/monitoring/RetrySchedulePreview.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 66 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 69 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 72 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 75 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 89 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 95 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 101 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 120 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 121 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 124 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 127 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 93 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 87 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/security/BlockedIPsPanel.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 64 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/security/IPWhitelistPanel.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 195 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 273 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 31 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Low | 117 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/settings/IntegrationKeysSection.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 192 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 264 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 268 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 272 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 276 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 301 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 70 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/settings/ai-providers/AIProviderFormDialog.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 134 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 149 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/settings/ai-providers/AIProviderHealthPanel.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 60 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 66 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 72 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 162 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Low | 170 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/settings/sla/SLARuleRow.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 56 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/settings/theme/BorderRadiusControl.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 19 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 27 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 36 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/settings/theme/ThemeDebugTooltip.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 34 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 34 | Literal Color | `text-emerald-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Low | 18 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 23 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 31 | Literal Color | `text-amber-600` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Medium | 149 | Literal Color | `text-red-600` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 157 | Literal Color | `text-red-600` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 79 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 93 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 150 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 156 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 82 | Literal Color | `text-green-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 94 | Literal Color | `text-green-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 106 | Literal Color | `text-yellow-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 106 | Literal Color | `text-green-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 156 | Literal Color | `text-blue-400` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 157 | Literal Color | `text-green-400` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 158 | Literal Color | `text-yellow-400` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 159 | Literal Color | `text-blue-400` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 160 | Literal Color | `text-blue-400` | Use semantic tokens (destructive, muted, popover, etc.) |
| Low | 155 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 115 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 116 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 117 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 119 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 151 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 182 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/ui/phone-input.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 118 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/ui/skip-link.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 91 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 111 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/components/voice/VoiceSearchOverlay.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 131 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 76 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/features/admin/components/FailedMessageTableRow.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 85 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 86 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/features/admin/components/MediaMigrationTool.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 146 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 209 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/features/admin/components/SicoobBridgeDashboard.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 131 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 135 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 209 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/features/admin/components/instance-pauses/AuthEventTrendChart.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 242 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Low | 209 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 257 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 258 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/features/admin/components/telemetry/StsCommercialDashboard.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 59 | Literal Color | `text-emerald-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 83 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 118 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 118 | Literal Color | `text-emerald-500` | Use semantic tokens (destructive, muted, popover, etc.) |

## src/features/admin/components/GmailWebhookMonitor.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 180 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 82 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/features/auth/components/mfa/MFAEnroll.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 135 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 172 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 305 | Literal Color | `bg-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 305 | Literal Color | `bg-rose-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 328 | Literal Color | `bg-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 77 | Literal Font | `font-sans` | Remove literal font class; use global typography |
...
| Low | 232 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 112 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 114 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 118 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 120 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 37 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 144 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
|----------|------|------|-------|------------|
| Low | 23 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 97 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/features/inbox/components/ThreadSLASettingsDialog.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 99 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 112 | Literal Color | `text-red-500` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 19 | Literal Font | `font-inter` | Remove literal font class; use global typography |
| Low | 36 | Literal Font | `font-inter` | Remove literal font class; use global typography |
| Low | 71 | Literal Font | `font-sans` | Remove literal font class; use global typography |
...
| Low | 127 | Literal Font | `font-sans` | Remove literal font class; use global typography |
| Low | 131 | Literal Font | `font-sans` | Remove literal font class; use global typography |
...
| Low | 311 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 414 | Literal Font | `font-sans` | Remove literal font class; use global typography |
| Low | 427 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 259 | Literal Font | `font-sans` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 17 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/features/inbox/components/chat/MessageAttemptsTimeline.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 98 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 100 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 110 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 114 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 118 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 124 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 133 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
|----------|------|------|-------|------------|
| Low | 126 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 236 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 279 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 283 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Low | 270 | Literal Font | `font-sans` | Remove literal font class; use global typography |
| Low | 290 | Literal Font | `font-sans` | Remove literal font class; use global typography |
| Low | 300 | Literal Font | `font-sans` | Remove literal font class; use global typography |
| Low | 417 | Literal Font | `font-sans` | Remove literal font class; use global typography |
| Low | 428 | Literal Font | `font-sans` | Remove literal font class; use global typography |
| Low | 453 | Literal Font | `font-sans` | Remove literal font class; use global typography |
| Low | 468 | Literal Font | `font-sans` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 33 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 34 | Literal Color | `text-amber-600` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 43 | Literal Color | `bg-amber-100` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 43 | Literal Color | `text-amber-700` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 58 | Literal Color | `bg-emerald-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 58 | Literal Color | `text-emerald-500` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 48 | Literal Font | `font-sans` | Remove literal font class; use global typography |
| Low | 57 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Low | 143 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 146 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/pages/AdminEvolutionApiLogsPage.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 239 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 270 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 298 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 308 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/pages/AdminInstancePausesPage.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 196 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 204 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 259 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 264 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
|----------|------|------|-------|------------|
| Low | 316 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 440 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 444 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 447 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 588 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/pages/AdminWebhookOverviewPage.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 356 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 375 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 385 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 438 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/pages/AdminWebhookSecretStatusPage.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 366 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 521 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 525 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 540 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 544 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 625 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Low | 175 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 205 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 207 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 208 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 28 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Low | 63 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 107 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 45 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 82 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
|----------|------|------|-------|------------|
| Low | 48 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 52 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 56 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 59 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 64 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 67 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 70 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/pages/admin-telemetria/TelemetryTopOffenders.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 30 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/pages/admin-webhook-overview/CallCorrelationView.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 110 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 137 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 153 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 202 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/pages/admin-webhook-secret-status/HmacSelfTestButton.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 335 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 83 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 98 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 103 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 163 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 175 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/pages/admin/AdminAutomationLogsPage.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 275 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 396 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 103 | Literal Color | `text-green-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Low | 158 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 347 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 389 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 447 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 457 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 489 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 494 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 568 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/pages/admin/AdminProvidersPage.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 128 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 186 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 193 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Low | 240 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 284 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 329 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 330 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/pages/admin/AdminWhatsAppModePage.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 277 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 305 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Low | 228 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 333 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 241 | Literal Color | `text-green-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Low | 185 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 199 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 239 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 267 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 350 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 415 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/pages/admin/RateLimitDashboard.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 191 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 217 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 266 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 269 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
|----------|------|------|-------|------------|
| Low | 264 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 309 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 333 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
|----------|------|------|-------|------------|
| Low | 187 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 190 | Literal Font | `font-mono` | Remove literal font class; use global typography |

## src/pages/admin/operations/OpsTransfersTab.tsx
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 73 | Literal Color | `text-amber-500` | Use semantic tokens (destructive, muted, popover, etc.) |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Low | 34 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 83 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 91 | Literal Font | `font-mono` | Remove literal font class; use global typography |
| Low | 114 | Literal Font | `font-mono` | Remove literal font class; use global typography |
...
| Priority | Line | Type | Value | Suggestion |
|----------|------|------|-------|------------|
| Medium | 193 | Literal Color | `bg-orange-500` | Use semantic tokens (destructive, muted, popover, etc.) |
| Medium | 194 | Literal Color | `bg-yellow-500` | Use semantic tokens (destructive, muted, popover, etc.) |
